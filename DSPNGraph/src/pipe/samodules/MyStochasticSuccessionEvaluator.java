...
public class MyStochasticSuccessionEvaluator <M,E>
  ...
  implements SuccessionEvaluator<PetriNet, Transition>
{
  ...
  {
					//这一行算出的succession是包含Petri网的变迁属性的，比如newlyenabled\persistent
					//属性的,不包含stochastic feature
					//所以我可以试一下覆盖这个函数？
    Succession succession = this.petriSuccessionEvaluator.computeSuccession(petriNet, state, fired);
