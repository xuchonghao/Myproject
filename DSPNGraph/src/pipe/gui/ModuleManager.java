...
public class ModuleManager
{
    ...
    private DefaultMutableTreeNode load_modules,samodule,steadymodule;
    ...
    File getModuleDirtest()
    {
        File modLocation = new File(ExtFileManager.getClassRoot(this.getClass()),
                                    System.getProperty("file.separator") + "pipe" +
                                            System.getProperty("file.separator") + "DSPNModules");
    ...
    public JTree getModuleTree()
    {
        ...
        /**这里是新加的*/
        samodule = new DefaultMutableTreeNode("DSPN Simulation Modules");
