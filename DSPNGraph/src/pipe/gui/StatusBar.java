   ...
   public void changeText(int type ){
      switch(type){
         ...
         case Constants.EXPTRANS:
             String textforExpTrans = "Exponential Transition Mode: Right click on a Transition to see menu " +
                     "options [Mouse wheel -> rotate]";
             changeText(textforExpTrans);
            break;
         case Constants.DETTANS:
             String textforDetTrans = "Deterministic Transition Mode: Right click on a Transition to see menu " +
                     "options [Mouse wheel -> rotate]";
             changeText(textforDetTrans);
            break;
