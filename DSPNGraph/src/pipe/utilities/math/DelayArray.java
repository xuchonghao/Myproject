...
public class DelayArray implements Serializable {
...
/**
    ...
    *
    */
   public DelayArray(DelayArray b) {
      this();
      this.m = b.m;
      this.n = b.n;
      A = b.A.clone();
    ...
    */
   public DelayArray(int vals[], int m) {
      this();
      this.m = m;
    ...
    */
   public DelayArray appendVector(DelayArray x) {
      DelayArray r = new DelayArray(m, n+1);
      // the extended matrix
    ...
    * @exception IllegalArgumentException All rows must have the same length
    */
   public static DelayArray constructWithCopy(int[][] A) {
      int m = A.length;
      int n = A[0].length;
      DelayArray x = new DelayArray(m,n);
      double[][] C = x.getArray();
      for (int i = 0; i < m; i++) {
         if (A[i].length != n) {
            throw new IllegalArgumentException
    ...
    */
   public DelayArray eliminateCol(int toDelete) {
      int m = getRowDimension(), n = getColumnDimension();
      DelayArray reduced = new DelayArray(m, n);
    ...
    */
   public DelayArray nonZeroIndices() {
      DelayArray x = new DelayArray(m, n);
   ...
   public int findNonMinimal() {
      ...
      DelayArray x = new DelayArray(m, 1); // column one, represents first col of comparison
      DelayArray y = new DelayArray(m, 1); // col two, represents rest columns of comparison
      DelayArray z = new DelayArray(m, 1); // difference column 1 - column 2
    ...
    * @exception ArrayIndexOutOfBoundsException Submatrix indices
    */
   public DelayArray getMatrix(int i0, int i1, int j0, int j1) {
      DelayArray x = new DelayArray(i1-i0+1,j1-j0+1);
      double[][] B = x.getArray();
      try {
         for (int i = i0; i <= i1; i++) {
    ...
    * @exception ArrayIndexOutOfBoundsException Submatrix indices
    */
   public DelayArray getMatrix(int[] r, int[] c) {
      DelayArray x = new DelayArray(r.length,c.length);
      double[][] B = x.getArray();
    ...
    * @exception ArrayIndexOutOfBoundsException Submatrix indices
    */
   DelayArray getMatrix(int i0, int i1, int[] c) {
      DelayArray x = new DelayArray(i1-i0+1,c.length);
      double[][] B = x.getArray();
    ...
    * @exception ArrayIndexOutOfBoundsException Submatrix indices
    */
   public DelayArray getMatrix(int[] r, int j0, int j1) {
      DelayArray x = new DelayArray(r.length,j1-j0+1);
      double[][] B = x.getArray();
   ...
   public int[] getNegativeIndices(int rowNo) {
      ...
      try {
         DelayArray a = new DelayArray(1, n);
   ...
   boolean isZeroRow(int r) {
      // TODO: optimize this!
      DelayArray a = new DelayArray(1, getColumnDimension());
    ...
    * @exception  ArrayIndexOutOfBoundsException Submatrix indices
    */
   void setMatrix(int i0, int i1, int j0, int j1, DelayArray x) {
      try {
         for (int i = i0; i <= i1; i++) {
            for (int j = j0; j <= j1; j++) {
    ...
    * @exception  ArrayIndexOutOfBoundsException Submatrix indices
    */
   public void setMatrix(int[] r, int[] c, DelayArray x) {
      try {
         for (int i = 0; i < r.length; i++) {
            for (int j = 0; j < c.length; j++) {
               A[r[i]][c[j]] = x.get(i,j);
    ...
    * @exception  ArrayIndexOutOfBoundsException Submatrix indices
    */
   public void setMatrix(int[] r, int j0, int j1, DelayArray x) {
      try {
         for (int i = 0; i < r.length; i++) {
            for (int j = j0; j <= j1; j++) {
    ...
    * @exception ArrayIndexOutOfBoundsException Submatrix indices
    */
   public void setMatrix(int i0, int i1, int[] c, DelayArray x) {
      try {
         for (int i = i0; i <= i1; i++) {
            for (int j = 0; j < c.length; j++) {
    ...
    * @return    A'
    */
   public DelayArray transpose() {
      DelayArray x = new DelayArray(n,m);
      double[][] C = x.getArray();
    ...
    */
   private double gcd2(double a, double b) {
      double gcd;
      a = Math.abs(a);
      b = Math.abs(b);
    ...
    * @return A + B
    */
   public DelayArray plus(DelayArray b) {
    ...
    * @return A + B
    */
   public void plusEquals(DelayArray b) {
      checkMatrixDimensions(b);
      for (int i = 0; i < m; i++) {
         for (int j = 0; j < n; j++) {
            A[i][j] = A[i][j] + b.A[i][j];
    ...
    * @return A - B
    */
   public DelayArray minus(DelayArray b) {
      checkMatrixDimensions(b);
      double[][] C = new double[m][n]; //= X.getArray();
      for (int i = 0; i < m; i++) {
         for (int j = 0; j < n; j++) {
            C[i][j] = A[i][j] - b.A[i][j];
         }
      }
       return new DelayArray(C);
   }
    ...
    * @return A - B
    */
   public DelayArray minusEquals(DelayArray b) {
      checkMatrixDimensions(b);
      for (int i = 0; i < m; i++) {
         for (int j = 0; j < n; j++) {
            A[i][j] = A[i][j] - b.A[i][j];
    ...
    */
   public int vectorTimes(DelayArray b) {
      int product = 0;
    ...
    */
   public static DelayArray identity(int m, int n) {
      DelayArray a = new DelayArray(m,n);
    ...
    */
   private void checkMatrixDimensions(DelayArray b) {
...
//   }
   ...
   public double[] getRow(int i){
      double[] r = new double[this.getRowDimension()];
