...
public class Expander
{
    ...
    private void unfoldTransitions()
    {
        ...
        for(TransitionView transitionView : transitionViews)
        {
            ...
            int transitiontype = transitionView.getType();
            ...
            String transtypeName = transitionView._typenameLabel.getName();
            double transTypeNameOffsetXInput = transitionView._typenameOffsetX;
            double transTypeNameOffsetYInput = transitionView._typenameOffsetY;
            
            TransitionView newTransitionView = new TransitionView(transPositionXInput, transPositionYInput, 
            		transIdInput, transIdInput, transNameOffsetXInput, transNameOffsetYInput, transitiontype, 
            		infServer, angleInput, new Transition(transIdInput, transIdInput, rateInput, priority), 
            		transtypeName, transTypeNameOffsetXInput,transTypeNameOffsetYInput);
