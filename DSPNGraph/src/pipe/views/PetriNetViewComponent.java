...
public abstract class PetriNetViewComponent extends JComponent implements Zoomable, CopyPasteable, Cloneable, Translatable, Serializable
{
    ...
    //add a typenameLable
    public NameLabel _typenameLabel;
    public double _typenameOffsetX;
    public double _typenameOffsetY;
    
    protected int _zoomPercentage;

    protected PetriNetViewComponent()
    {
        this(null, null, 0, 0, 0, 0, null, 0, 0);
    }
    ...
    PetriNetViewComponent(String id, String name, double positionX, double positionY, double nameOffsetX, double nameOffsetY, String typename, double typenameOffsetX, double typenameOffsetY)
    {
        _id = id;
        _positionX = positionX;
        _positionY = positionY;
        ...
        _typenameLabel = new NameLabel(typename, _zoomPercentage, typenameOffsetX, typenameOffsetY);
    }

    public void setNameLabelName(String name)
    {
        _nameLabel.setName(name);
    }

    public void setTypeNameLabelName(String name)
    {
        _typenameLabel.setName(name);
    }
    ...
    public NameLabel getTypeNameLabel()
    {
	...
	public void setTypeNameOffsetX(double typenameOffsetXInput) {
		_typenameOffsetX += ZoomController.getUnzoomedValue(typenameOffsetXInput, _zoomPercentage);
	}

	public void setTypeNameOffsetY(double typenameOffsetYInput) {
		_typenameOffsetY += ZoomController.getUnzoomedValue(typenameOffsetYInput, _zoomPercentage);
	}
    ...
    String getTypeNameLabelName()
    {
        return _typenameLabel.getName();
    }

    void setTypeNameLabel(NameLabel nameLabel)
    {
        _typenameLabel = nameLabel;
    }
}
