...
public abstract class ConnectableView extends PetriNetViewComponent implements Cloneable, IObserver,Serializable
{
    ...
    {
        this(positionX, positionY, id, "", Constants.DEFAULT_OFFSET_X, Constants.DEFAULT_OFFSET_Y, model,"", 0, 35);
    }
    ...
    ConnectableView(double positionX, double positionY, String id, String name, double nameOffsetX, double nameOffsetY, Connectable model, String typename, double typenameOffsetX, double typenameOffsetY)
    {
        super(id, name, positionX, positionY, nameOffsetX, nameOffsetY, typename, typenameOffsetX, typenameOffsetY);
        _model = model;
...
//
//    public void setTypeName(String nameInput)
//    {
//        super.setTypeNameLabelName(nameInput);
//    }
