...
public class TypeAction extends GuiAction
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        //System.out.println("xuchonghao" + " "+ this.toString() + " ," + pipeApplicationView.placeAction);
        ...
        if(this != pipeApplicationView.exptransAction)
        {
            pipeApplicationView.exptransAction.setSelected(false);
        }
        if(this != pipeApplicationView.dettransAction)
        {
            pipeApplicationView.dettransAction.setSelected(false);
        }
